...
search = Request.request service method  where
    service = Request.ServiceName "CloudSearchDomain"
    method = Request.MethodName "search"
...
suggest = Request.request service method  where
    service = Request.ServiceName "CloudSearchDomain"
    method = Request.MethodName "suggest"
...
uploadDocuments = Request.request service method  where
    service = Request.ServiceName "CloudSearchDomain"
    method = Request.MethodName "uploadDocuments"
